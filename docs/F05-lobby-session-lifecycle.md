...
- First-ever session: before start, Hook Weaver runs its deferred pass — reads the actual selected characters' backstories and fills the backstory hook slots from F4 Stage 6 (proposals to DM console in assist; auto in full-AI).
