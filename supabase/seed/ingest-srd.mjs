...
async function buildItems() {
  ...
  return insertStatement('srd_items', ['key', 'name', 'category', 'data'], rows)
}
...
async function main() {
  ...
  const header =
    ...
    'truncate table srd_class_features, srd_classes, srd_spells, srd_monsters, srd_items restart identity cascade;\n\n'
